...
export { XmlAttribute, XmlCdata, XmlCharRef, XmlComment, XmlDecl, XmlDocument, XmlDtd, XmlDtdAttlist, XmlDtdElement, XmlDtdEntity, XmlDtdNotation, XmlDtdParamEntityRef, XmlElement, XmlEntityRef, XmlNode, XmlProcInst, XmlText };
/**
